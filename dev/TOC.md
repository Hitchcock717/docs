...
+ Reference
  ...
  + SQL
    ...
    + Data Types
      - [Numeric Types](/dev/reference/sql/data-types.md#numeric-types)
      - [Date and Time Types](/dev/reference/sql/data-types.md#date-and-time-types)
      - [String Types](/dev/reference/sql/data-types.md#string-types)
      - [JSON Types](/dev/reference/sql/data-types.md#json-types)
      - [The ENUM Data Type](/dev/reference/sql/data-types.md#the-enum-data-type)
      - [The SET Type](/dev/reference/sql/data-types.md#the-set-type)
